                ...
                <div class="row justify-content-center">
                    <div class="col-md-7 col-lg-5">
                        ...
                        <div style="text-align: center; margin-bottom: 20px">
                            <img style="width: auto; max-height: 90px;"
                                src="{{ asset('/assets/images/logo/logo-large.png') }}" id="site_logo" alt="logo-image">
                        </div>
                        ...
                        <div class="reset-page-wrapper text-center">
                            <form name="resetpasswordform" roll="form" class="row reset-password-form r-10"
                                ...
                                <div class="col-md-12">
                                    <div class="reset-form-title">
                                        ...
                                        <p class="p-sm color--grey">
                                            {{ __('default.Please enter your email address. If the account exists, we will send a password reset link to your email address.') }}
                                        </p>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-12">
                                    <input class="form-control email @error('email') is-invalid @enderror"
                                        ...
                                        placeholder="ornek@izedebiyat.com" required autocomplete="email" autofocus>
                                    @error('email')
                                ...
                                <div class="col-md-12">
                                    <div class="form-data text-center">
                                        <span><a
                                                href="{{ route('login') }}">{{ __('default.It\'s okay, I found my password!') }}</a></span>
                                    </div>
                                </div>
