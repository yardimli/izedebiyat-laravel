...
<head>
    ...
    <meta name="description" content="İzEdebiyat - {{ __('default.Boilerplate Site Tagline') }}">
        ...
        <div class="bg-primary pt-5 pb-0 position-relative">
            ...
            <div class="container">
                <div class="row justify-content-center text-center">
                    <div class="col-12">
                        <!-- Title -->
                        <h1 class="display-4 text-white mb-4 position-relative">İzEdebiyat</span>'a Tekrar Hoş Geldiniz!
                        </h1>
                        </h1>
                            ...
                            <form roll="form" class="mt-4" method="POST" action="{{ route('password.update') }}">
                                ...
                                <div class="mb-3 position-relative input-group-lg">
                                    ...
                                    <input id="email" type="email"
                                        class="form-control @error('email') is-invalid @enderror" aria-label="E-posta"
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="input-group input-group-lg">
                                        <input type="password"
                                            class="form-control fakepassword psw-input @error('password') is-invalid @enderror"
                                            aria-label="Şifre" id="psw-input" name="password"
                                            placeholder="Yeni Şifre..." value="" required
                                    ...
                                    <div class="input-group input-group-lg">
                                        <input type="password" class="form-control fakepassword2"
                                            aria-label="Şifre Onayı" id="password-confirm" name="password_confirmation"
                                            placeholder="Şifreyi Onaylayın..." value="" required
                                            autocomplete="new-password">
                                        <span class="input-group-text p-0"><i
                                ...
                                <div class="d-grid">
                                    <button type="submit"
                                        class="btn btn-lg btn-primary-soft">{{ __('default.Reset Password') }}</button>
                                </div>
                                <!-- Copyright -->
                                <p class="mb-0 mt-3">©2025 <a target="_blank"
                                        href="https://www.izedebiyat.com/">izedebiyat</a> Tüm hakları saklıdır</p>
        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-sm-10 col-md-8 col-lg-6">
                    <div
                        class="d-grid d-sm-flex justify-content-center justify-content-sm-between align-items-center mt-3">
                        <!-- Nav -->
                    </div>
                </div>
            </div>
