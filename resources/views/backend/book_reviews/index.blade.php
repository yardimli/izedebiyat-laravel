                                        ...
                                        <tbody>
                                            @foreach ($bookReviews as $review)
                                                <tr>
                                                    ...
                                                    <td>
                                                        <span
                                                            class="badge bg-{{ $review->is_published ? 'success' : 'warning' }}">
                                                    ...
                                                    <td>
                                                        <div class="btn-group">
                                                            <a href="{{ route('frontend.book-review.show', $review->slug) }}"
                                                                ...
                                                                target="_blank">{{ __('default.View') }}</a>
                                                            <a href="{{ route('book-reviews.edit', $review->id) }}"
                                                                class="btn btn-sm btn-primary">{{ __('default.Edit') }}</a>
                                                            <form action="{{ route('book-reviews.destroy', $review->id) }}"
                                                                method="POST" class="d-inline"
                                                                onsubmit="return confirm('{{ __('default.Are you sure?') }}')">
                                                                @csrf
                                                                @method('DELETE')
                                                                <button type="submit"
