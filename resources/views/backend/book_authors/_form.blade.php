...
<div class="mb-3">
    ...
    @if (isset($bookAuthor) && $bookAuthor->picture)
        <div class="mt-2">
            ...
            <img src="{{ $bookAuthor->picture }}" alt="{{ $bookAuthor->name }}" class="img-fluid mt-1"
...
<div class="mb-3">
    ...
    <textarea class="form-control" id="biography_textarea" name="biography" rows="10">{{ old('biography', $bookAuthor->biography ?? '') }}</textarea>
</div>

{{-- Bibliography --}}
<div class="mb-3">
    <label for="bibliography_textarea" class="form-label">Bibliyografya (Eserleri)</label>
    <textarea class="form-control" id="bibliography_textarea" name="bibliography" rows="10">{{ old('bibliography', $bookAuthor->bibliography ?? '') }}</textarea>
</div>
