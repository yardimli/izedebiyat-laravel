                ...
                <div class="col-lg-8 mx-auto">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body p-3">
                            E-posta adresinizi doğruladığınız için teşekkür ederiz. Artık eserlerinizi yazmaya
                            başlayabilirsiniz.
                            <br>
                            <br>
                            ...
                            <div style="text-align: center; ">
                                <img src="{{ asset('/assets/images/logo/logo-large.png') }}" style="height: 200px;"
                                    alt="Teşekkürler" class="img-fluid">
                            </div>
                        </div>
                    </div>
                    <!-- Kart BİTİŞ -->
