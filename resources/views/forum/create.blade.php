        ...
        <div class="forum-container">
            ...
            <div class="forum-composer-card forum-create-card">
                <div class="forum-composer-heading">
                    ...
                    <div><span>Yeni bir sohbet açın</span>
                        <h1>Tartışma Başlat</h1>
                    </div>
                </div>

                @if ($errors->any())
                    <div class="forum-errors"><strong>Lütfen aşağıdakileri düzeltin:</strong>
                        <ul>
                    ...
                    <div class="forum-create-fields">
                        <label>
                            ...
                            <select name="forum_tag_id" required>
                                ...
                                @foreach ($tags as $tag)
                                    <option value="{{ $tag->id }}" @selected(old('forum_tag_id') == $tag->id)>{{ $tag->name }}
                                    </option>
                                @endforeach
                            </select>
                        </label>
                        <label class="forum-title-field">
                            ...
                            <input type="text" name="title" value="{{ old('title') }}" maxlength="180"
                                placeholder="Neyi konuşmak istersiniz?" required>
                        </label>
                    </div>
                    <div class="forum-editor" data-quill-editor data-placeholder="İletinizi yazın...">
                        {!! old('body') !!}</div>
