...
<head>
	...
	<meta name="description"
	      content="{{__('default.Ä°zEdebiyat')}} - {{__('default.Boilerplate Site Tagline')}}">
					...
					<ul class="dropdown-menu dropdown-animation dropdown-menu-end pt-3 small me-md-n3"
						...
						@else
							<li><a class="dropdown-item bg-primary-soft-hover" href="{{ route('login') }}"><i
										class="bi bi-unlock  me-2"></i>GiriÅŸ Yap</a></li>
							<li><a class="dropdown-item bg-primary-soft-hover" href="{{ route('register') }}"><i
										class="bi bi-person-circle  me-2"></i>Ãœye Ol</a></li>
						@endif
