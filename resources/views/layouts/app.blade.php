            ...
            <div class="container">
                ...
                <a class="navbar-brand" href="{{ route('frontend.index') }}">
                    <img class="light-mode-item navbar-brand-item"
                        src="{{ asset('assets/images/logo/logo-large.png') }}" alt="logo">
                    <img class="dark-mode-item navbar-brand-item"
                        src="{{ asset('assets/images/logo/logo-large-transparent.png') }}" alt="logo">
                </a>
                <!-- Logo END -->
                        ...
                        @if (Auth::check())
                            <li class="nav-item">
                                <a class="nav-link active"
                                    href="{{ route('user', Auth::user()->slug) }}">{{ __('default.My Page') }}</a>
                            </li>
                            ...
                            <li class="nav-item">
                                <a class="nav-link"
                                    href="{{ route('articles.create') }}">{{ __('default.Start Writing') }}</a>
                            </li>

                            <li class="nav-item">
                                <a class="nav-link" href="{{ route('chat') }}">{{ __('default.Chat') }}</a>
                            </li>
                        @endif
                        @if (Auth::check())
                            @if (Auth::user()->member_type === 1)
                                @if (false)
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link {{ request()->routeIs('admin.articles.*') ? 'active' : '' }}"
                                            href="{{ route('admin.articles.index') }}">Yaz</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link {{ request()->routeIs('admin.read-cleanup.*') ? 'active' : '' }}"
                                            href="{{ route('admin.read-cleanup.index') }}">Oku</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link {{ request()->routeIs('book-reviews.*') ? 'active' : '' }}"
                                            href="{{ route('book-reviews.index') }}">Kit Iz</a>
                                    </li>
                                    {{-- ADDED: Link to Book Authors admin page --}}
                                    <li class="nav-item">
                                        <a class="nav-link {{ request()->routeIs('book-authors.*') ? 'active' : '' }}"
                                            href="{{ route('book-authors.index') }}">Kit Yaz</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link {{ request()->routeIs('admin.forum.*') ? 'active' : '' }}"
                                            href="{{ route('admin.forum.index') }}">Forum</a>
                                    </li>
                                    {{-- END ADDED --}}
                                @endif
                                @if (false)
                                    <li class="nav-item dropdown">
                                        <a class="nav-link dropdown-toggle {{ request()->routeIs('admin.*') ? 'active' : '' }}"
                                            ...
                                            aria-expanded="false">Y�netim</a>
                                        <ul class="dropdown-menu">
                                            <li><a class="dropdown-item"
                                                    href="{{ route('admin-users-index') }}">Kullanici Y�netimi</a>
                                            </li>
                                            <li><a class="dropdown-item"
                                                    href="{{ route('admin.articles.index') }}">Yazi Y�netimi</a></li>
                                            <li><a class="dropdown-item"
                                                    href="{{ route('admin.read-cleanup.index') }}">Okuma Kayitlarini
                                                    Temizleme</a></li>
                                            <li><a class="dropdown-item"
                                                    href="{{ route('book-reviews.index') }}">Kitap Incelemeleri</a>
                                            </li>
                                            <li><a class="dropdown-item"
                                                    href="{{ route('book-authors.index') }}">Kitap Yazarlari</a></li>
                                            <li><a class="dropdown-item"
                                                    href="{{ route('admin.forum.index') }}">Forum Y�netimi</a></li>
                                            <li>
                                                <hr class="dropdown-divider">
                                            </li>
                                            <li><a class="dropdown-item"
                                                    href="{{ route('admin.quotes.index') }}">Edebiyat Alintilari</a>
                                            </li>
                                            <li><a class="dropdown-item"
                                                    href="{{ route('admin.llm-settings.edit') }}">LLM Ayarlari</a>
                                            </li>
                                            <li><a class="dropdown-item"
                                                    href="{{ route('admin.account-recovery.index') }}">Hesap Kurtarma
                                                    Talepleri</a></li>
                                        </ul>
                                    </li>
                                @endif
                                <li class="nav-item dropdown">
                                    <a class="nav-link dropdown-toggle {{ request()->routeIs('admin.*') ? 'active' : '' }}"
                                        href="#" role="button" data-bs-toggle="dropdown"
                                        aria-expanded="false">Y&#246;netim</a>
                                    <ul class="dropdown-menu">
                                        <li><a class="dropdown-item"
                                                href="{{ route('admin-users-index') }}">Kullan&#305;c&#305;
                                                Y&#246;netimi</a></li>
                                        <li><a class="dropdown-item"
                                                href="{{ route('admin.articles.index') }}">Yaz&#305; Y&#246;netimi</a>
                                        </li>
                                        <li><a class="dropdown-item"
                                                href="{{ route('admin.read-cleanup.index') }}">Okuma
                                                Kay&#305;tlar&#305;n&#305; Temizleme</a></li>
                                        <li><a class="dropdown-item" href="{{ route('book-reviews.index') }}">Kitap
                                                &#304;ncelemeleri</a></li>
                                        <li><a class="dropdown-item" href="{{ route('book-authors.index') }}">Kitap
                                                Yazarlar&#305;</a></li>
                                        <li><a class="dropdown-item" href="{{ route('admin.forum.index') }}">Forum
                                                Y&#246;netimi</a></li>
                                        <li>
                                            <hr class="dropdown-divider">
                                        </li>
                                        <li><a class="dropdown-item"
                                                href="{{ route('admin.quotes.index') }}">Edebiyat
                                                Al&#305;nt&#305;lar&#305;</a></li>
                                        <li><a class="dropdown-item"
                                                href="{{ route('admin.llm-settings.edit') }}">LLM Ayarlar&#305;</a>
                                        </li>
                                        <li><a class="dropdown-item" href="{{ route('writer.budgets.index') }}">Yapay
                                                zek&#226; kotalar&#305;</a></li>
                                        <li><a class="dropdown-item"
                                                href="{{ route('admin.account-recovery.index') }}">Hesap Kurtarma
                                                Talepleri</a></li>
                        ...
                        <a class="nav-link btn icon-md p-0" href="#" id="profileDropdown" role="button"
                            ...
                            @if (Auth::user())
                                <img class="avatar-img rounded-circle"
                                    ...
                                    alt="avatar">
                            @else
                                <img class="avatar-img rounded-2" src="/assets/images/avatar/placeholder.jpg"
                                    alt="">
                            @endif
                        </a>
                            ...
                            <div
                                ...
                                <button type="button" class="btn btn-modeswitch nav-link text-primary-hover mb-0"
                                    ...
                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                        fill="currentColor" class="bi bi-sun  mode-switch" viewBox="0 0 16 16">
                                        <path
                                ...
                                <button type="button" class="btn btn-modeswitch nav-link text-primary-hover mb-0"
                                    ...
                                    data-bs-title="Dark">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                        fill="currentColor" class="bi bi-moon-stars  mode-switch"
                                        viewBox="0 0 16 16">
                                        <path
                                ...
                                <button type="button"
                                    ...
                                    data-bs-title="Auto">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                        fill="currentColor" class="bi bi-circle-half  mode-switch"
                                        viewBox="0 0 16 16">
