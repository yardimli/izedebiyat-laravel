            ...
            <div class="container-lg">
                <div class="entry-header">
                    <div class="mb-5">
                        ...
                        <p style="font-family: Arial, Helvetica, sans-serif; font-size: 16px;">İzEdebiyat yazarların
                            gizliliğini
                        ...
                        <p style="font-family: Arial, Helvetica, sans-serif; font-size: 16px;">İzEdebiyat sitede yer alan
                            yazıların üzerinde herhangi bir hak talep etmez. Yazarlar sayfalarında yer alan tüm metinlerin
                            haklarını
                        ...
                        <p style="font-family: Arial, Helvetica, sans-serif; font-size: 16px;">Bir yazar sayfasını büsbütün
                            ...
                            adıyla yukarıdaki adrese gönderilmesi durumunda sayfa en geç birkaç gün içinde kapatılacaktır.
                            Tüm kişisel
                        ...
                        <p style="font-family: Arial, Helvetica, sans-serif; font-size: 16px;">Saklılık hakkının yazar
                            üzerine getirdiği tek yükümlülük yayınlanan yazılardan yazarın sorumlu olmasıdır. İzEdebiyat
                            temelde bir
                            ...
                            İzEdebiyat giriş yapılan yazıları elinden geldiğince böyle bir riske karşı denetlemeye
                            çalışmaktadır.
                            Yine de yazarların, tarafımızca ya da yasalarca yapılacak herhangi bir uyarıya maruz kalmaksızın
                            bu
                            duyarlılığı göstereceklerini varsayıyoruz. </p>

                        <p style="font-family: Arial, Helvetica, sans-serif; font-size: 16px;"><b>Yazarlardan ne tür
                                bilgiler
                                topluyoruz?</b></p>

                        <p style="font-family: Arial, Helvetica, sans-serif; font-size: 16px;">Ad, email, posta adresi
                            dışında
                            İzEdebiyat tüm
                            kullanıcıların
                            ...
                            girdiğinde onu tanıyabiliyoruz. Bu, gerektiğinde ona kişisel hizmetler sunmamız olanaklı
                            kılıyor.
                            ...
                            girmiş olduğunuzun kaydını tutuyordur. Cookie bilgileri yalnız şifre sahipleri
