        ...
        <div class="row justify-content-center">
            <div class="col-lg-8">
                <div class="card">
                    ...
                    <div class="card-body">
                        <p class="text-muted">Hesabınıza erişiminizi kaybettiyseniz, lütfen aşağıdaki formu doldurun.
                            Ekibimiz talebinizi inceleyecek ve size yardımcı olacaktır.</p>
                        ...
                        <form action="{{ route('account-recovery.store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="mb-3">
                                ...
                                <div class="form-text">Lütfen hesabınızı oluştururken kullandığınız gerçek adınızı ve
                                    soyadınızı girin.</div>
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <div class="form-text">Hesabınızla ilişkili olabileceğini düşündüğünüz tüm e-posta
                                    adreslerini (erişiminiz olmasa bile) virgülle ayırarak yazın.</div>
                            </div>

                            <div class="mb-3">
                                <label for="profile_url" class="form-label">İzEdebiyat Profil Sayfanızın Adresi (İsteğe
                                    Bağlı)</label>
                                <input type="url" class="form-control" id="profile_url" name="profile_url"
                                    value="{{ old('profile_url') }}"
                                    placeholder="https://www.izedebiyat.com/yazar/kullanici-adiniz">
                                <div class="form-text">Erişmeye çalıştığınız profil sayfanızın tam adresini biliyorsanız
                                    buraya yapıştırın.</div>
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <div class="form-text">Size ulaşabileceğimiz ve yeni şifrenizi göndereceğimiz güncel bir
                                    e-posta adresi girin.</div>
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <div class="form-text">
                                    ...
                                    <strong>Önemli:</strong> Güvenliğiniz için, fotoğrafınız dahil olmak üzere adınız ve
                                    doğum yılınız dışındaki tüm bilgileri karalayarak gizleyebilirsiniz.
                                </div>
                            </div>

                            {{-- ADDED: Checkbox for account deletion request --}}
                            <div class="form-check mb-3">
                                <input class="form-check-input" type="checkbox" name="delete_account" id="delete_account"
                                    value="1" {{ old('delete_account') ? 'checked' : '' }}>
                                <label class="form-check-label" for="delete_account">
                                    Hesabımı ve tüm içeriğini kalıcı olarak silmek istiyorum. Bu işlemin geri
