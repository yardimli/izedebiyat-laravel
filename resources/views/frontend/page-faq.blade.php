				...
				<div class="entry-header">
					<div class="mb-5">
						...
						<p class="mt-5" style="font-family:Arial, Helvetica, sans-serif; font-size:16px;">
							...
							Herkese! Elbette bir şeyler (mümkünse de iyi bir şeyler) yazıyor olmalısınız. İzEdebiyat bir sosyal
							paylaşım
							sitesi ya da arkadaş bulma sitesi değil. Ama bu, site içerisinde harika arkadaşlar edinemeyeceğiniz
							anlamına
						...
						<p class="mt-5" style="font-family:Arial, Helvetica, sans-serif; font-size:16px;">
							...
							Eserinizi ne kadar derli toplu, kullandığınız dil ne kadar anlaşılır ve düşünceleriniz ne kadar özgün
							olursa,
						...
						<p class="mt-5" style="font-family:Arial, Helvetica, sans-serif; font-size:16px;">
							...
							bugüne kadar bu sadece bir düşünce olarak kaldı. Aynı zamanda İzEdebiyat'ın olabildiğince reklamsız bir
							site
						...
						<p class="mt-5" style="font-family:Arial, Helvetica, sans-serif; font-size:16px;">
							...
							Bütün sayfalarda yer alan Katılım bağlantısını tıklayarak hemen üye olabilirsiniz. Aynı zamanda <a
								href="/resources/views/frontend/page-sign-up-step-1.blade.php">burayı tıklayarak</a> da hemen üye
						...
						<p class="mt-5" style="font-family:Arial, Helvetica, sans-serif; font-size:16px;">
							...
							(Ulusal günlerimizde sitenin tepesinde göreceğiniz güzel bir Atatürk resmi sitenin politik eğilimi
							hakkında
						...
						<p class="mt-5" style="font-family:Arial, Helvetica, sans-serif; font-size:16px;">
							...
							anlayışı gereğince, sitede yeri olmayan bir yazının sitede uzun süre barınması da çoğunlukla olanaklı
							olmuyor.
							...
							düşüklükleri ve yanlış sınıflandırma (örn. bir şiiri inceleme kümesinin altına koymak) başı çekiyor. Ama
							"baş
						...
						<p class="mt-5" style="font-family:Arial, Helvetica, sans-serif; font-size:16px;">
							<b>İzEdebiyat'ta bana ait bir
								...
								yapmalıyım?</b><a
								name="10" id="10"></a><br>
							Öncelikle yazıyı yükleyen kişiye bu durumu bildirip, yazıyı kaldırmasını isteyebilirsiniz. Bundan herhangi
							bir
						...
						<p class="mt-5" style="font-family:Arial, Helvetica, sans-serif; font-size:16px;"><b>İzEdebiyat'ta yer alan
								bir
							...
							moderatörünün iyi niyetine güvenmek dışında yapabileceğiniz fazla bir şeyin olmaması. İnternette yer alan
							tüm
							belge ve görsellerin bir anlamda "kamuya açık" olduğunu unutmayın. Biz, her ne kadar, sitenin her
							sayfasına
							sitedeki tüm yazıların haklarının yazarlarına ait olduğunu belirtsek de, kötü niyetli ya da sorumsuz
							birileri
							buradan beğendikleri yazıları alıp, kendi sitelerinde sergileyebiliyorlar. Evet, bu durum bizim de
							hoşumuza
							gitmiyor ama bizim de elimiz kolumuz sizinki kadar bağlı. Burada -bize kalırsa- dikkat edilmesi gereken en
							önemli "ahlaki" boyut, yazıyı kendi sitesine taşıyan kişinin, isminizi de beraberinde taşıyıp taşımaması.
							Size
						...
						<p class="mt-5" style="font-family:Arial, Helvetica, sans-serif; font-size:16px;"><b>Yazılarımın haklarını
								elde
						...
						<p class="mt-5" style="font-family:Arial, Helvetica, sans-serif; font-size:16px;">
							<b>Facebook ve benzeri sosyal
								...
								name="13" id="13"></a><br>
							Buna kendiniz karar verebilirsiniz. Ancak bu toplulukların hiçbirinin İzEdebiyat tarafından kurulmadığını
							ve
						...
						<p class="mt-5" style="font-family:Arial, Helvetica, sans-serif; font-size:16px;">
							...
							2003 yılında çıkardığımız e-debiyat Yıllığı, övünerek belirtelim ki, medyada bir hayli ilgi çekmişti.
							Radikal,
							CNN Türk vb. medya kurumlarının arşivlerini tarayan biri, bu eser hakkında bol bol yazı bulacaktır. Ancak
							satış anlamında tam bir fiyasko yaşadık. Sitenin üyelerinin %1'i bile bu dev kitabı almaya yanaşmadı.
							(Satılan
							kitapların neredeyse tümü kitabevlerinde satıldı.) Dolayısıyla bu işe bir daha girişmeme kararı aldık.
							Ancak
							prensiplerimize her zaman uymak gibi bir prensibimiz yok. Dolayısıyla, günün birinde, elbette tekrar böyle
							bir
							maceraya atılabiliriz... Biraz da yazarlardan alacağımız geri dönüşlere bağlı böyle şeyler.<br>
							<a href="#tepe" class="btn btn-sm btn-primary">TEPE</a>
						</p>
						
						<p class="mt-5" style="font-family:Arial, Helvetica, sans-serif; font-size:16px;"><b>İzEdebiyat sitesini ne
								zaman
							...
							düşünüyoruz. Bir sosyal paylaşım sitesi olmaması dolayısıyla, chat, video vb. özellikler koymayı çok
							anlamlı
						...
						<p class="mt-5" style="font-family:Arial, Helvetica, sans-serif; font-size:16px;">
							...
							paylaşabilirsiniz. Temiz ve anlaşılır bir dil ve saygılı bir üslupla yazılmış bir eleştiri, aklı başında
							bütün
							yazarların ciddiye alacağı bir şeydir. Yazıda herhangi bir fikir yoksa ya da yer alan fikirler sağduyu ve
							akıl
							sınırlarının dışındaysa, hemen yazının altında bulunan KÖTÜ İÇERİK BİLDİR düğmesini tıklayarak, bizi
							uyarabilirsiniz. Fazla imla hatası, özensizlik, saldırganlık, seviyesizlik, bölücülük, rahatsız edici
							derecede
							pornografik içerik ya da resim... içinize sinmeyen herhangi bir şey varsa, gecikmeden bizi uyarın.<br>
							<a href="#tepe" class="btn btn-sm btn-primary">TEPE</a>
						</p>
						
						<p class="mt-5" style="font-family:Arial, Helvetica, sans-serif; font-size:16px;"><b>İzEdebiyat'ın
								arkasındaki
							...
							bulunmak istiyorsanız, bu nazik teklifinizi ne yazık ki geri çevirmek durumundayız. İzEdebiyat'ın tüm
							yönetici
							ve editörleri yayın ve kitap dünyasında çalışan insanlar. Sitemiz bizim için en değerli varlıklarımızdan
							biri
