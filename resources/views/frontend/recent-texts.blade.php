...
@section('title', 'İzEdebiyat - Son Eklenen Yazılar')
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-9">
                                        <h3 class="entry-title mb-2">
                                            <a
                                                href="/yapit/{{ $article->slug }}">{{ \App\Helpers\MyHelper::replaceAscii($article->title) }}</a>
                                        </h3>
                                        ...
                                        <div class="entry-meta">
                                            ...
                                            <a
                                                href="/kume/{{ $article->parent_category_slug }}/{{ $article->category_slug }}">{!! $article->category_name !!}
                                            </a>
                                            <br>
