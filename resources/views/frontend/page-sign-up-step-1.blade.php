				...
				<div class="entry-header">
					<div class="mb-5">
						...
						<p style="font-family: Arial, Helvetica, sans-serif; font-size: 16px">
							...
							metinlerin internet ortamında yayınlanması ve geniş bir okur kitlesine ulaşmasını sağlamaktır. Baştan
							sonra
							...
							editörlerce okunmuyorlar anlamına gelmez. Editörlerimizin sizden en önemli beklentileri şiir, öykü ve
							deneme
							türlerinde gönderdiğiniz metinlerin gerçekten birer şiir, birer öykü, ya da deneme olmalarıdır. Aynı
							şekilde
							bilimsel metinlerin gerçekten bilimsel, incelemelerin de gerçekten inceleme olmaları gerekir. Bu konuyla
							ilgili ayrıntılı bilgiyi aşağıda bulacaksınız. Bunun dışında sitenin birinci amacı yazı yazan herkese bir
							okur
