...
@section('title', 'İzEdebiyat - Katılım')
                ...
                <div class="entry-header">
                    <div class="mb-5">
                        ...
                        <p style="font-family: Arial, Helvetica, sans-serif; font-size: 16px; font-weight: bold">
                            Yazarlık kaydınız on-on beş dakikadan uzun sürmeyecektir. Ancak lütfen oraya ilerlemeden önce bu
                            metni
                            dikkatle okuyun.
                        </p>

                        <p style="font-family: Arial, Helvetica, sans-serif; font-size: 16px">
                            <span style="font-weight: bold">İzEdebiyat</span>'ın temel işlevi, edebi, bilimsel, felsefi ve
                            sanatsal
                            metinlerin internet ortamında yayınlanması ve geniş bir okur kitlesine ulaşmasını sağlamaktır.
                            Baştan
                            sonra
                            özgürlük<span style="font-style: italic"> </span>ve eşitlik ilkeleri üzerine kurulu yapı ürün
                            veren <span style="font-weight: bold">tüm yazar ve yazar adaylarına açıktır.</span> Bu özelliği
                            sayesinde de dünyada
                            türünün tek örneğidir! İzEdebiyat'ta yayınlanan yazılar, editörlerce elenerek seçilmezler, ancak
                            bu
                            editörlerce okunmuyorlar anlamına gelmez. Editörlerimizin sizden en önemli beklentileri şiir,
                            öykü ve
                            deneme
                            türlerinde gönderdiğiniz metinlerin gerçekten birer şiir, birer öykü, ya da deneme olmalarıdır.
                            Aynı
                            şekilde
                            bilimsel metinlerin gerçekten bilimsel, incelemelerin de gerçekten inceleme olmaları gerekir. Bu
                            konuyla
                            ilgili ayrıntılı bilgiyi aşağıda bulacaksınız. Bunun dışında sitenin birinci amacı yazı yazan
                            herkese bir
                            okur
                            kapısı açmaktır. Bu doğrultuda çok genel bazı yayın ilkeleri dışında, gönderilen tüm metinler
                            siteye kabul
                            edilmektedir.
                        </p>

                        <p
                            style="font-family: Trebuchet MS, Tahoma, Arial,sans-serif; font-size: 24px; font-weight: bold; ">
                        ...
                        <p style="text-align: center">
                            <a href="{{ route('frontend.principles') }}">
                                <img src="/frontend/anagrafikler/dugme_katilim.gif" width="250" height="70"
                                    style="border: 0">
                            </a>
                        </p>
