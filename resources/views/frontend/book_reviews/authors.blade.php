            ...
            <div class="content-widget">
                <div class="container-lg">
                    <div class="row">
                        <div class="col-12">
                            <h4 class="spanborder">
                                <span>{{ __('default.Book Reviews') }} - Kitap Yazarları</span>
                            </h4>
                        </div>
                    </div>
                                    ...
                                    <div class="card-body text-center">
                                        <a href="{{ route('frontend.book-reviews.author', $author->slug) }}">
                                            <img src="{{ $author->picture ?? asset('assets/images/avatar/placeholder.jpg') }}"
                                                class="rounded-circle mb-3" alt="{{ $author->name }}"
                                                style="width: 100px; height: 100px; object-fit: cover;">
                                        </a>
                                        <h5 class="card-title">
                                            <a
                                                href="{{ route('frontend.book-reviews.author', $author->slug) }}">{{ $author->name }}</a>
                                        </h5>
