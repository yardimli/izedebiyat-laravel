            ...
            <div class="row">
                <div class="col-12 col-xl-8 col-lg-8 mx-auto">
                    ...
                    <div class="alert alert-info d-flex align-items-center" role="alert">
                        ...
                        <div>
                            Bu form aracılığıyla kitabınızın sitemizde incelenmesini talep edebilirsiniz. Başvurunuzu
                            aldıktan sonra,
                            <span style="font-weight:bold;">değerlendirmemizi yapabilmemiz için kitabınızın tam metnini
                                .docx formatında talep edeceğiz.</span>
                    ...
                    <form method="POST" action="{{ route('frontend.book-reviews.store-submission') }}"
                        ...
                        <div class="mb-3">
                            ...
                            <input type="file" class="form-control" id="book_cover_image" name="book_cover_image"
                        ...
                        <div class="mb-3">
                            ...
                            <small class="form-text text-muted">Eğer yazar sistemde mevcutsa, bilgilerini yine de giriniz.
                                Mevcut
                        ...
                        <div class="mb-3">
                            ...
                            <input type="file" class="form-control" id="author_picture" name="author_picture"
                                accept="image/*">
                        </div>
                        ...
                        {{-- Author Bibliography --}}
                        <div class="mb-3">
                            <label for="author_bibliography" class="form-label">Yazarın Diğer Eserleri (Bibliyografya -
                                İsteğe
                                Bağlı)</label>
