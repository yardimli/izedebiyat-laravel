            ...
            <div class="author-header-container my-4 p-4 rounded">
                <div class="row align-items-center">
                    <div class="col-md-3 text-center">
                        <img src="{{ $author->picture ?? asset('assets/images/avatar/placeholder.jpg') }}"
                            class="img-fluid rounded-circle" alt="{{ $author->name }}"
                            ...
                            <div class="col-12 mb-4">
                                <div class="book-grid-item">
                                    <a href="{{ route('frontend.book-review.show', $review->slug) }}">
                                        <img src="{{ $review->cover_image ?? asset('images/no-image.png') }}"
                                            class="img-fluid book-cover" alt="{{ $review->title }}">
                                        <div class="book-info-overlay">
                                            <h5 class="book-title">{{ $review->title }}</h5>
                                            <span
                                                class="btn btn-sm btn-outline-light">{{ __('default.Read Review') }}</span>
                                        </div>
                                    </a>
                                </div>
                            </div>
