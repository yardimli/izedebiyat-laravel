                    ...
                    <div class="row">
                                        ...
                                        <div class="col-md-9">
                                            <div class="align-self-center" style="min-height: 200px;">
                                                ...
                                                <div class="entry-meta align-items-center">
                                                    <a
                                                        href="{{ url('/yazar/' . $article->name_slug) }}">{{ $article->name }}</a><br>
                        ...
                        <div class="col-md-4 pl-md-5 sticky-sidebar">
                            ...
                            <div class="text-center" style="position:relative;">
                                ...
                                {!! \App\Helpers\MyHelper::generateInitialsAvatar(
                                    $user->avatar,
                                    $user->email,
                                    'border-radius: 10px; width:60%; min-width:150px; min-height:150px;',
                                    'mt-2 mb-2',
                                ) !!}
                            </div>
                            ...
                            @php
$followingUsers = $user->following()->with('following')->get(); @endphp

                            @if ($followingUsers->count() > 0) <div class="following-users mt-4 mb-4">
                ...
                <div class="pagination-container">
                    <div class="pagination">
                        <div class="pagination-info">
                            <span>{{ $totalItems }} yazı içinden
                                {{ ($currentPage - 1) * $perPage + 1 }}-{{ min($currentPage * $perPage, $totalItems) }}
                                arası görüntüleniyor</span>
                        </div>
    ...
    @auth
        <div class="modal fade author-pdf-modal" id="authorPdfModal" tabindex="-1" aria-labelledby="authorPdfModalLabel"
                    ...
                    <div class="modal-body">
                        @if ($articles->total() > 50)
                            <div class="alert alert-warning small mb-3" role="alert">
                                Bu yazarın {{ $articles->total() }} yazısı var. PDF hazırlama işlemi 5 dakikaya kadar
                                sürebilir; indirme başlayana kadar lütfen bu sayfayı ve pencereyi açık bırakın.
                            </div>
                        @endif
                        <div class="mb-3">
                        ...
                        <div class="form-check mb-2">
                            ...
                            <input class="form-check-input" type="checkbox" value="1" id="authorPdfIncludeToc"
                                name="include_toc" checked>
    ...
    @endauth
    @auth
        <div class="modal fade author-pdf-modal" id="downloadStartedModal" tabindex="-1"
            aria-labelledby="downloadStartedModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered">
    ...
    @endauth
    @guest
        <div class="modal fade author-pdf-modal" id="authorPdfLoginModal" tabindex="-1"
            aria-labelledby="authorPdfLoginModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    <div class="modal-header">
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#authorPdfForm').on('submit', async function(event) {
                ...
                $('#authorPdfSubmit').prop('disabled', true).html(
                ...
                const optionsModal = bootstrap.Modal.getInstance(optionsModalEl) || new bootstrap.Modal(
                    optionsModalEl);
