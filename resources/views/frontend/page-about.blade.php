            ...
            <div class="mb-5">
                ...
                <div class="entry-meta align-items-center">
                    <p class="text-center">
                        ...
                        <br>
                        <span
                            style="font-family: Arial, Helvetica, sans-serif; color: red; font-size: 2rem; font-weight: bold">İzEdebiyat
                            Nedir?</span>
                    </p>

                    <p style="text-align: center;" class="mt-3">
                        <a href="#paylasma"><img src="/frontend/ikon/102.gif" style="width:43px; height:43px;"
                                class="mt-1 mb-0"></a>
                        <a href="#tanisma"><img src="/frontend/ikon/37.gif" style="width:43px; height:43px;"
                                class="mt-1 mb-0" alt="Tanışma"></a>
                        <a href="#yuzlesme"><img src="/frontend/ikon/80.gif" style="width:43px; height:43px;"
                                class="mt-1 mb-0" alt="Yüzleşme"></a>
                        <a href="#eglence"><img src="/frontend/ikon/99.gif" style="width:43px; height:43px;"
                                class="mt-1 mb-0" alt="Eğlence"></a>
                        <a href="#imgelem"><img src="/frontend/ikon/48.gif" style="width:43px; height:43px;"
                                class="mt-1 mb-0" alt="İmgelem"></a>
                        <a href="#ozgurluk"><img src="/frontend/ikon/107.gif" style="width:43px; height:43px;"
                                class="mt-1 mb-0" alt="Özgürlük"></a>
                        <a href="#katilim"><img src="/frontend/ikon/116.gif" style="width:43px; height:43px;"
                                class="mt-1 mb-0" alt="Katılım"></a>
                    </p>
                    ...
                    <div class="text-center mb-2">
                        <a name="katilim"></a>
                        <h3 class="text-center"
                            style="font-family: Tahoma, Verdana, Arial; font-size: 2rem; text-transform: uppercase;">— K A
                            T I L I M
                            —</h3>
                    ...
                    <div class="text-center">
                        ...
                        <p style="font-family: Tahoma, Verdana, Arial; font-size: 2rem; font-weight: bold; color: #FF0033">
                            Yazmak.<br><br>
                            <a href="/resources/views/frontend/page-sign-up-step-1.blade.php" style="font-size: 1rem;">
                                Sonra da burayı tıklayarak kendinize bir İzEdebiyat Kişisel Yazar sayfası açmak.
                            </a>
                        </p>
                    </div>

                    <div style="text-align: center; font-family: Times New Roman, Times, serif; font-size: 1.5rem;">
