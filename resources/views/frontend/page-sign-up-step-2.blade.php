            ...
            <div class="container-lg">
                <div class="entry-header">
                    <div class="mb-5">
                        ...
                        <ul
                            style="font-family:Arial, Helvetica, sans-serif; font-size:16px; margin-top:0px; padding-top: 0px;">
                            <li>İzEdebiyat'ta
                            ...
                            <li>Bir
                                yazı yayınlandıktan sonra alıntı uzunluğunun 1/5'den fazla olması, temelsiz suçlamalarda
                                bulunması ve
                                benzeri
                        ...
                        <p class="mt-3 text-center">
                            <a href="{{ route('register') }}"><img src="/frontend/anagrafikler/dugme_katilim2.gif"
                                    width="250" height="70" border="0"></a>
                        </p>
                    </div>
                </div>
            </div>
