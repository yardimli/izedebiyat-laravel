				...
				<div class="entry-meta align-items-center">
					...
					<p style="text-align: center;" class="mt-3">
						<a href="#paylasma"><img src="/frontend/ikon/102.gif" style="width:43px; height:43px;" class="mt-1 mb-0"
							></a>
						<a href="#tanisma"><img src="/frontend/ikon/37.gif" style="width:43px; height:43px;" class="mt-1 mb-0"
						                        alt="Tanışma"
							></a>
						<a href="#yuzlesme"><img src="/frontend/ikon/80.gif" style="width:43px; height:43px;" class="mt-1 mb-0"
						                         alt="Yüzleşme"></a>
						<a href="#eglence"><img src="/frontend/ikon/99.gif" style="width:43px; height:43px;" class="mt-1 mb-0"
						                        alt="Eğlence"
							></a>
						<a href="#imgelem"><img src="/frontend/ikon/48.gif" style="width:43px; height:43px;" class="mt-1 mb-0"
						                        alt="İmgelem"
							></a>
