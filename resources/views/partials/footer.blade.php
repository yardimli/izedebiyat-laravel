    ...
    <div class="container">
        ...
        <div class="row mb-1">
            <ul class="inline text-md-right">
                ...
                <li class="list-inline-item entry-excerpt"><a href="{{ route('account-recovery.create') }}">Hesabıma
                        Erişemiyorum</a></li>
                ...
                <li class="list-inline-item entry-excerpt"><a href="{{ url('/yayin-ilkeleri') }}">Yayın İlkeleri</a>
                </li>
        ...
        <div class="row">
            ...
            <div class="col-md-12 mt-2 mb-1">
                <div class="text-center">
                    <a href="https://bookcoverzone.com" style="font-family:Verdana; font-size:12px;"><img
                            src="/images/bookcoverzone-logo.jpg" alt="Custom &amp; Premade Book Covers"
                            style="width:64px"><br>Book Cover Zone - Premade Book Covers</a>
                </div>
            </div>
            <div class="col-md-9 text-muted" style="font-size: 12px;">
                İzEdebiyat'da yayınlanan bütün yazılar, telif hakları yasalarınca korunmaktadır. Tümü yazarlarının ya da
                telif hakkı sahiplerinin izniyle sitemizde yer almaktadır. Yazarların ya da telif hakkı sahiplerinin
                izni olmaksızın sitede yer alan metinlerin -kısa alıntı ve tanıtımlar dışında- herhangi bir biçimde
                basılması/yayınlanması kesinlikle yasaktır.
