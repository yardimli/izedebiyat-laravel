    ...
    <div class="text-right">
        <div class="container-lg mobile-menu-fixed pr-5">
            <a class="navbar-brand" href="{{ route('frontend.index') }}">
                <img class="light-mode-item navbar-brand-item" src="{{ asset('assets/images/logo/logo-large.png') }}"
                    alt="logo">
                <img class="dark-mode-item navbar-brand-item"
                    src="{{ asset('assets/images/logo/logo-large-transparent.png') }}" alt="logo">
            </a>

            <button type="button" class="nav-link btn btn-light p-0" id="modeSwitcher-mobile"
        ...
        <nav class="mobile-mega-menu" aria-label="Mobil ana menü">
                ...
                <details class="mobile-mega-item">
                    <summary>
                        ...
                        <span class="mobile-menu-summary-meta">
                            ...
                            @endif
                            <small>{{ number_format($category->menu_total) }} toplam</small><i
                                class="bi bi-chevron-down"></i>
                        </span>
                    </summary>
                    <div class="mobile-mega-panel">@include('partials.mega-menu-content', [
                        'menuType' => 'category',
            ...
            <form action="{{ route('search') }}" method="get" class="mobile-mega-search">
                ...
                <input type="search" name="q" value="{{ request('q') }}"
                    placeholder="Eser, yazar veya konu ara..." aria-label="Ara">
...
<div id="wrapper">
    <header id="header" class="d-lg-block d-none">
            ...
            <div class="w-100 d-flex align-items-center">
                ...
                <div class="header-right w-50 float-end">
                    ...
                    <form action="{{ route('search') }}" method="get" class="search-form d-lg-flex float-end">
                        ...
                        <input type="text" class="search_field" name="q" value="{{ request('q') }}"
                            placeholder="Ara...">
                    </form>
                </div>
            </div>
        ...
        @if (config('features.kitap_izleri_visible') &&
                (request()->routeIs('frontend.book-review.*') || request()->routeIs('frontend.book-reviews.*')))
