                                ...
                                <div class="row g-0">
                                    ...
                                    <div class="col-md-10 col-8">
                                        <div class="card-body">
                                            <h5 class="card-title">
                                                <a
                                                    href="{{ route('frontend.book-review.show', $randomBookReviewForAd->slug) }}">{{ $randomBookReviewForAd->title }}</a>
                                            </h5>
                                            <p class="card-text"><small
                                                    class="text-muted">{{ $randomBookReviewForAd->display_author }}</small>
                                            </p>
