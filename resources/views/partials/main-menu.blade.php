        ...
        <div class="menu-primary">
            <ul class="mega-menu-root">
                <li class="mega-menu-item current-menu-item">
                    ...
                    <button class="mega-menu-toggle" type="button" aria-expanded="false"
                        aria-label="Ana Sayfa menüsünü aç"><i class="bi bi-chevron-down"></i></button>
                ...
                @foreach ($mainMenuCategories as $category)
                    <li class="mega-menu-item">
                        ...
                        <button class="mega-menu-toggle" type="button" aria-expanded="false"
                            aria-label="{{ strip_tags($category->category_name) }} menüsünü aç"><i
                                class="bi bi-chevron-down"></i></button>
                        <div class="mega-menu-panel">@include('partials.mega-menu-content', [
                            'menuType' => 'category',
                ...
                @if (config('features.kitap_izleri_visible'))
                    <li class="mega-menu-item">
                        ...
                        <button class="mega-menu-toggle" type="button" aria-expanded="false"
                            aria-label="Kitap İzleri menüsünü aç"><i class="bi bi-chevron-down"></i></button>
                ...
                <li class="mega-menu-item">
                    ...
                    <button class="mega-menu-toggle" type="button" aria-expanded="false"
                        aria-label="Forum menüsünü aç"><i class="bi bi-chevron-down"></i></button>
