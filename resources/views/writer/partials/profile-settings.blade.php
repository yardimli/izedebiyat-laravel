<div class="tab-pane" id="nav-setting-tab-1">
    ...
    <div class="card mb-4">
        ...
        <div class="card-body">
            ...
            <form action="{{ route('backend.update') }}" method="post" class="row g-3" enctype="multipart/form-data">
                @csrf
                <!-- First name -->
                ...
                <form action="{{ route('backend.sifre-guncelle') }}" method="post" class="row g-3">
                    ...
                    <div class="col-12">
                        ...
                        <div class="input-group">
                            <input class="form-control fakepassword psw-input" type="password" name="new_password"
                                id="psw-input" placeholder="Yeni Şifrenizi Girin">
                            <button type="button" class="input-group-text profile-password-toggle"
    ...
    <script>
        $(document).ready(function() {
            ...
            const easyMDE = new EasyMDE({
                ...
                lineWrapping: true,
                status: ["lines", "words"],
                toolbar: ["bold", "italic", "heading", "quote", "link", "horizontal-rule", "|",
...
@push('scripts')
    <script>
        passwordStrengthMeter({
            ...
            messagesList: ['Şifrenizi girin', 'Fazla basit', 'Basit', 'Güzel', 'Harika'],
            height: 8,
            borderRadius: 4,
            pswMinLength: 8
        });
