...
return [
    ...
    'user',
    'Sign up with Google',
    'This page is still waiting for its first title.',
    'The author’s own story is still resting between the lines.',
    'The paths beyond this page are yet to be traced.',
    'If you joined with Google, use the password reset link to set your first password.',
    ...
    'Story title',
    'Start writing',
    'Shall this story meet its readers?',
    'Finding a home for your story…',
    'Publish story',
    'Keep as draft',
    'Your unfinished stories are waiting.',
    'A few pages still rest on your desk. Return to them whenever the words arrive.',
    'Back to my desk',
    'Create a new story to begin. Its title can always change later.',
